        ...
        <div className="container min-h-[80vh] flex items-center justify-center py-20">
            ...
            >
                <div className="space-y-4 text-center">
                    <span className="text-[10px] font-black uppercase tracking-[0.5em] text-muted-foreground/40">Identity Genesis</span>
                    <h1 className="text-5xl font-black tracking-tighter uppercase italic">Register</h1>
                    <p className="text-xs font-black uppercase tracking-widest text-muted-foreground/60">
                        Join the architectural dialogue
                    </p>
                </div>

                <form onSubmit={handleSubmit} className="space-y-6 p-12 border-4 border-foreground shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] bg-background">
                    {error && (
                    ...
                    <div className="space-y-4">
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                className="rounded-none border-2 border-muted h-12 font-black bg-muted/5 focus:border-foreground"
                                required
                            />
                        </div>
                        <div className="space-y-2">
                        ...
                        <div className="space-y-2">
                            <Label className="font-black uppercase text-[10px] tracking-widest flex items-center gap-2">
                                <Lock className="h-3 w-3" /> Confirm Key
                            </Label>
                            <Input
                                type="password"
                    ...
                    <Button
                        type="submit"
                        disabled={loading}
                        className="w-full rounded-none h-16 font-black uppercase tracking-widest bg-foreground text-background hover:bg-foreground/90 transition-all text-sm group mt-6"
                    >
                        {loading ? "Generating..." : (
